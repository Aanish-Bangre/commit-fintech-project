    ...
    <div className="min-h-screen px-6 py-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">No-Code Strategy Builder</h1>
        ...
        <Card className="p-8">
          ...
          <div className="rounded-lg h-96 flex items-center justify-center border-2 border-dashed border-gray-300">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-lg">Drag indicators here to start building your strategy</p>
